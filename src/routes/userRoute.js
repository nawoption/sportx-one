...
const { userAccountCreateSchema, userAccountUpdateSchema } = require("../validations/accountValidation");
...
// Agent routes
router.post("/register/by-agent", validateBody(userAccountCreateSchema), agentAuth, userController.register);
...
// Master routes
router.post("/register/by-master", validateBody(userAccountCreateSchema), masterAuth, userController.register);
...
// Senior routes
router.post("/register/by-senior", validateBody(userAccountCreateSchema), seniorAuth, userController.register);
...
// Admin routes
router.post("/register/by-admin", adminAuth, validateBody(userAccountCreateSchema), userController.register);
